                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <p>Top 10 des meilleurs ventes</p><br>
                        ...
                        <div class="col-lg-12">
                            <p>Top 10 des vins de meilleur qualité (ordre décroissant)</p><br>
                            <div id="loadpartial" class="fh-fixedHeader col-md-10 col-sm-8 main-content">
                      			<table id="schedule" class="display table-condensed table table-hover table-bordered dt-responsive responsive-display" style="width:100%">
                      				<thead style="height: ">
                                        <tr>
                        ...
                        <div class="col-lg-12">
                            <p>Relation du mode de culture par rapport à son prix</p><br>
                        ...
                        <div class="col-lg-12">
                            <p>Classement des meilleurs cépages en fonction de la qualité de leurs vins</p><br>
                            <div id="loadpartial" class="fh-fixedHeader col-md-10 col-sm-8 main-content">
                                <table id="schedule" class="display table-condensed table table-hover table-bordered dt-responsive responsive-display" style="width:100%">
                                    <thead style="height: ">
                                        <tr>
                        ...
                        <div class="col-lg-12">
                            <p>Relation entre la qualité des vins et la moyenne du nombre de traitements qu'ils ont subi</p><br>
                            <div id="loadpartial" class="fh-fixedHeader col-md-10 col-sm-8 main-content">
                                <table id="schedule" class="display table-condensed table table-hover table-bordered dt-responsive responsive-display" style="width:100%">
                                    <thead style="height: ">
                                        <tr>
                        ...
                        <div class="col-lg-12">
                            <p>Mise en parallèle des évènements climatiques et du prix unitaire de vente des vins (par type, puis par prix croissant)</p><br>
                            <div id="loadpartial" class="fh-fixedHeader col-md-10 col-sm-8 main-content">
                                <table id="schedule" class="display table-condensed table table-hover table-bordered dt-responsive responsive-display" style="width:100%">
                                    <thead style="height: ">
                                        <tr>
